...
const dbPool = (0, db_config_1.createPool)();
    ...
    describe('DELETE /api/users/:id', () => {
        ...
        beforeEach(async () => {
            ...
            try {
                ...
                const result = await client.query('INSERT INTO users (first_name, last_name, email, password_digest) VALUES ($1, $2, $3, $4) RETURNING id', ['Delete', 'Test', uniqueEmail, hashedPassword]);
